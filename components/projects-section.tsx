            ...
            {filteredProjects.map((project) => (
              ...
              >
                ...
                <div className={`absolute top-6 right-6 px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                  project.category === 'Hardware' ? 'bg-blue-100 text-blue-700' :
                  project.category === 'Dev' ? 'bg-green-100 text-green-700' :
                  project.category === 'College' ? 'bg-purple-100 text-purple-700' :
